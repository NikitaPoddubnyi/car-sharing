import { IsBoolean, IsEnum, IsNotEmpty, IsNumber, IsString, MaxLength, MinLength, IsOptional } from "class-validator";
...
export class CreateBikeDto {
    ...
    @IsEnum(GearBox) @IsNotEmpty()
    gearBox: GearBox;

    @IsEnum(TyreType) @IsNotEmpty()
    tyreType: TyreType;
